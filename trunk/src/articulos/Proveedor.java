...
public Proveedor(int codentrada, String nomentrada, String cifentrada, String telentrada, String direntrada, String webentrada, String faxentrada)
{
    
	// Para dar de alta un objeto "proveedor" necesitamos como mínimo su cif, su nombre fiscal y su direccion, sino no se cursa el alta.
	try
	{
		if ((cifentrada.length()>0) && (direntrada.length()>0) && (nomentrada.length()>0)) 
		{
		...
		{	
			throw new VideoException("No se ha cursado el alta del proveedor, faltan datos. Se debe inroducir como minimo el nombre, el cif y la direccion");
		}
	}	
	...
	public void crearAlta(int cod1, String nom1, String ci1, String telefono1, String dir1, String web1, String fa1)
	{
        // Para dar de alta un objeto "proveedor" necesitamos como mínimo su cif, su nombre fiscal y su direccion, sino no se cursa el alta.
